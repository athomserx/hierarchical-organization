...
export class InitialMigration1762402727885 implements MigrationInterface {
    name = 'InitialMigration1762402727885'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_permissions" ("userId" uuid NOT NULL, "permissionId" uuid NOT NULL, CONSTRAINT "PK_4d0e283b03781d1796e62dc6195" PRIMARY KEY ("userId", "permissionId"))`);
